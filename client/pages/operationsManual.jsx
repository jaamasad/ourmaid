...
const OperationsManual = () => {
  ...
  return (
    <>
      <MainHead
        metaTitle="Operations Manual. OurMaids Franchise, Inc."
        metaDesc="Look at our Operations Manual here. Download it if you are authorized and be hereby notified of delivery for use according to the franchise contractual agreement."
      />
      <div>
          ...
          <div className="mt-[10%] w-[650px] shadow-lg shadow-black  rounded border-black aspect-[1/1.3] mb-4 overflow-hidden">
            <div className="flex flex-row bg-gray-100 items-center justify-between p-2 rounded-t">
              ...
              <div>
                ...
                <button
                  className="rounded p-2 bg-pink-800 text-white hover:bg-pink-700"
                ...
                {showModal && (
                  <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg p-4 max-w-md mx-auto">
                      ...
                      <button
                        className="bg-pink-500 hover:bg-pink-400 text-white rounded-md py-2 px-4 mr-2"
