defmodule Ourmaid.Accounts do
  ...
  alias Ourmaid.Accounts.{User, UserToken, UserNotifier}
  ...
  ## Examples
      ...
      iex> deliver_update_username_instructions(user, current_username, &Routes.user_update_username_url(conn, :edit, &1))
      {:ok, %{to: ..., body: ...}}
